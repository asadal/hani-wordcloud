...
st.set_page_config(
        ...
        page_icon="https://cdn.creazilla.com/icons/3231954/word-cloud-icon-size_512.png"
    )
...
st.image("https://cdn.creazilla.com/icons/3231954/word-cloud-icon-size_512.png", width=150)
